function [z_out,tag,test_save, rho_mat, time_mat, max_time] = ADMM_DR_asy_ARock( f, g, rel_mat, rho, max_step, epsi_rel, epsi_abs, accuracy, empty_tag, rand_num )
...
%             A_set = BA(1, 1:rand_num);
            ...
            epsi_dual = sqrt(p_size*Np)*epsi_abs+epsi_rel*norm(BB'*YY);
