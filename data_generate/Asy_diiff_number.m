...
%     [delta_temp_sy, ADMM_step_sy, test_save, rho_mat, A_set_save] = ADMM_DR_asy_ARock(f, g, rel_mat, rho, max_step, epsi_rel, epsi_abs, delta_temp1, empty_tag, 10);
    res{1,tt}.node_num = size(rel_mat,1);
    set_num = round(0.8*res{1,tt}.node_num);
    [res{1,tt}.delta_temp_sy, res{1,tt}.ADMM_step_sy, res{1,tt}.test_save, res{1,tt}.rho_mat, res{1,tt}.A_set_save] = ADMM_DR_asy_ARock(f, g, rel_mat, rho, max_step, epsi_rel, epsi_abs, delta_temp1, empty_tag, set_num);
