...
%         profile on
        tic
        [res{1,tt}.delta_temp_sy, res{1,tt}.ADMM_step_sy, res{1,tt}.test_save, res{1,tt}.rho_mat, res{1,tt}.time_save, res{1,tt}.max_time] = ADMM_DR_asy_ARock(f, g, rel_mat, rho, max_step, epsi_rel, epsi_abs, delta_temp1, empty_tag, tt);
        toc
%         profile viewer
    end
