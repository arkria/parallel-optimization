...
public:
	...
	void AsyFor(int max_step, int output_step, int thread_num, int rand_num);
	void synFor(int max_step, int output_step, int thread_num, int rand_num);
	void Iteration(int max_step, int output_step, int thread_num, int rand_num);
	real_t * getSolution(real_t *cen_ans, double cen_time);
	double getTotalTIme();
	int iter_step;
...
private:
	...
	bool check_conv_record(int tag, int max_step, int output_step);
	void updateRho();
};
